...
class AuthManager:
    ...
    def create_user(self, username: str, password: str, role: str) -> str:
        ...
        log.info(f"User '{username}' created (role={role})")
        return user_id
    ...
    def authenticate(self, username: str, password: str) -> str:
        ...
        if not user or user["password_hash"] != self._hash_password(password):
            log.warning(f"Authentication failed: user '{username}'")
        ...
        log.info(f"User '{username}' authenticated")
        return token
    ...
    def generate_api_key(self, user_id: str) -> str:
        ...
        log.info(f"API Key generated for user '{username}'")
        return api_key
    ...
    def change_password(self, user_id: str, old_password: str, new_password: str) -> None:
        ...
        log.info(f"User '{username}' password changed")
