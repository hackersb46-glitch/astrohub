...
# isIrreversible=true 的加密方式
key = hashlib.sha256((salt + username + password).encode()).hexdigest()
...
body = '<SessionLogin><userName>' + username + '</userName><password>' + key + '</password><sessionID>' + sessionID + '</sessionID></SessionLogin>'
